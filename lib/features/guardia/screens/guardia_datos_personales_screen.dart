...
class GuardiaDatosPersonalesScreen extends StatefulWidget {
  ...
  const GuardiaDatosPersonalesScreen({
    super.key,
  ...
  @override
  State<GuardiaDatosPersonalesScreen> createState() =>
      _GuardiaDatosPersonalesScreenState();
}

class _GuardiaDatosPersonalesScreenState
    extends State<GuardiaDatosPersonalesScreen> {
  ...
  Future<void> _guardar() async {
    ...
    if (!_validarCorreo(_correoCtrl.text.trim())) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
  ...
  Widget build(BuildContext context) {
    ...
    final fotoUrl = widget.usuario['guardia']?['foto_url'] ?? '';
            ...
            Center(
              child: CircleAvatar(
                ...
                child: fotoUrl.isEmpty
                    ? Text(
                        nombres.isNotEmpty ? nombres[0].toUpperCase() : 'G',
