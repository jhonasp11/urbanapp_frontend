...
import 'perfil_datos_screen.dart';
import 'perfil_contrasena_screen.dart';
import 'perfil_documentos_screen.dart';
...
class _PerfilScreenState extends State<PerfilScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final fotoUrl = residente['foto_url'] ?? '';
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Residente • Manzana $manzana • Villa $villa',
                          style: const TextStyle(
                      ...
                      children: [
                        _buildOpcion(
                          ...
                          onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (_) =>
                                  PerfilDatosScreen(usuario: _usuario ?? {}),
                            ),
                          ).then((_) => _cargar()),
                        ),
                        ...
                        _buildOpcion(
                          ...
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const PerfilContrasenaScreen(),
                            ),
                          ),
                        ),
                        const Divider(height: 1, color: AppColors.border),
                        _buildOpcion(
                          ...
                          onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => const PerfilDocumentosScreen(),
                            ),
                          ),
                        ),
                      ],
