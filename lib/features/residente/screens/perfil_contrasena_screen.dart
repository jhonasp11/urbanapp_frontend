...
class PerfilContrasenaScreen extends StatefulWidget {
  const PerfilContrasenaScreen({super.key});

  @override
  State<PerfilContrasenaScreen> createState() => _PerfilContrasenaScreenState();
}

class _PerfilContrasenaScreenState extends State<PerfilContrasenaScreen> {
  ...
  Future<void> _actualizar() async {
    ...
    try {
      ...
      await _api.patch('/usuarios/$userId/contrasena', data: {
